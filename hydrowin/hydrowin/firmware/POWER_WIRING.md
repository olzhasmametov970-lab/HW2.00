...
- **SIM для поля:** IoT/M2M с шагом тарификации **1 КБ** (бюджет телеметрии ≤100 МБ/мес).
  Обычная «голосовая» SIM часто округляет до 10 КБ за сессию. Проверка на плате: Serial **`TRAFFIC`**.
