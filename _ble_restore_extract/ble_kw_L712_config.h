...
// ADC1 (OK с Wi‑Fi): GPIO35, 34, 33, 32, 36, 39
// ADC2 (при Wi‑Fi часто мусор): GPIO25, 26, 27, 14
// GPIO36/39 — только вход (ADC), без выходного режима.
// Неиспользуемые каналы: DISABLE <ch> (по умолчанию ch3..ch9 выкл).

#define MAX_SENSORS 10

// Офлайн-очередь телеметрии во flash (LittleFS), пока нет Wi‑Fi/GSM.
#define OFFLINE_QUEUE_MAX_FILES   120   // ~120 пакетов, старые удаляются
#define OFFLINE_FLUSH_BATCH         8   // за один успешный цикл отправки
...
// channel → GPIO: 0:35 1:34 2:33 3:32 4:25 5:26 6:27 7:14 8:36 9:39
#define SENSOR_TABLE \
    ...
    { 36, 8,   0.0f, 250.0f, "ch8", false }, \
    { 39, 9,   0.0f, 250.0f, "ch9", false }
